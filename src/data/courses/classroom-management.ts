...
export const classroomManagementCourse = {
  title: "Classroom Management Skill",
  image: "/images/courses/classroom-management-detail.jpg",
  pageIntro: [
    "One of the most important and difficult task the teacher has to play is in managing the classroom. For effective teaching and learning to take place a well managed classroom offering a conducive environment to learn is of prime importance. Classroom management is not confined to the management and discipline of students but includes making certain that stressful and non-educational situations are best avoided and students continue to learn enjoy and grow in a productive and peaceful environment.",
    "It is critical to understand and realize the effort made by teachers to create and maintain a well managed classroom.",
    "Managing the classroom includes various intricacies of student learning that take account of expectations, interactions, motivation and behaviour.",
    "The specialized course in Classroom Management offered by Global Teacher Training Academy (GTT Academy) is a 4 month course and imparts detailed knowledge about techniques required for effective management which could be completed with ease through flexible learning methods of Online Learning. The certificate which is globally accepted, awarded on completion of the course can be effective to add optimum value to the credibility of a teacher.",
  ],
  focus: [
    "To optimize student learning and achievement through successful implementation of classroom management skills.",
    "To facilitate student engagement.",
    "To educate teachers in maintaining classroom time effectively.",
    "Acquiring techniques to help maintain a positive classroom atmosphere and sound behaviour management by avoiding classroom indiscipline.",
  ],
  ...
  phases: [
    ...
    {
      title: "Phase 2",
      items: ["The Components", "The Teacher", "Multi-tasking", "The Student"],
    },
    {
      title: "Phase 3",
      items: [
    ...
    {
      title: "Phase 5",
      items: ["Large Group Management", "Time and Material Management"],
    },
    {
      title: "Phase 6",
      items: ["Case Studies"],
  ...
  fee: "Classroom Management is a specialized course which not only teaches the skills necessary for efficient classroom management but are also practiced regularly by teachers who aim to optimize their student's learning capabilities. You need eligibility criteria of completion of grade 12 or graduation to apply for this Online/ Distance course to learn the early childhood teaching methodologies. You may pursue this course by spending a reasonable fee of 10000 INR + GST or 160 USD along with tutor guidance and course material support .",
  shared: {
    accreditation: [
