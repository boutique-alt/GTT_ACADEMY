...
export const psychologyCourse = {
  title: "Diploma in Child Psychology",
  image: "/images/courses/psychology-detail.jpg",
  pageIntro: [
    "Child psychology, is the study of the psychological processes of children and specifically, how they develop from birth to the end of adolescence, how these processes differ from those of adults, and how and one child differs from the next. Diploma in Child Psychology from Global Teacher Training Academy (GTT Academy) is a unique course that helps to equip learners with an holistic approach to foster the development of young children from birth to 6 years of age and will be of interest to functionaries and teachers working with children from birth to 6 years of age, in diverse settings, such as crèches, preschools, pre-primary classes, nursery schools.",
    "The course is also ideal for those wishing to set up early childhood care and education centers or managing such centers; parents and others interested in knowing about the development of young children. The Diploma Course on Child Psychology from GTT Academy is a 8 months course which could be completed with ease through flexible learning methods of Online Learning. The advantages of taking this course are that you can study it anywhere and from any device. The certificate which is globally accepted, awarded on completion of the course can be effective to add optimum value to the credibility of a teacher.",
  ],
  focus: [
    "To gain knowledge and develop skills and attitudes required for working with young children in crèches, preschools, nursery schools, kindergartens and day care centers.",
    "To gain knowledge of parenting styles and how they affect child's development.",
    "To obtain awareness on how children form relationships with others.",
  ...
  whoCanJoin: [
    "Professionals: Individuals working as a nurse, health and childcare worker etc.",
    "Teachers: Practicing teachers who would like to benefit and amplify their opportunities working as a child psychologists.",
    "Aspirants: Fresher's who wish to become behavioral psychologists.",
    "Parents/Young mothers: Parents who wish to learn about the psychology of their children.",
    "Homemakers: Homemakers who wish to work as child psychologists in schools.",
    "Career Changers-This program will benefit those eager to change their career and start practicing as a child psychologists.",
  ],
  phases: [
    {
      title: "Phase 1 Child Psychology and early years of development",
      items: [
        "Meaning of Child Psychology",
        "Nature of Child Psychology",
        "Dr. Montessori's Work on Child Psychology",
        "Originality of Montessori's Psychology",
      ],
    },
    {
      title: "Phase 2 Development and initial growth phase of the child",
      items: [
        "Concept of Growth and Development",
        "Stages of Development",
        "Determinants of Development: Heredity and Environment",
        "Dr. Montessori's View on Child Development",
        "Theory of the Montessori Method: Unique position of Man at Birth and the Laws of Natural",
      ],
    },
    {
      title: "Phase 3 Pre-school children and their developmental features",
      items: [
    ...
    {
      title: "Phase 4 Creativity, Motivation and unique differences in children",
      items: [
    ...
    {
      title: "Phase 5 Blossoming and learning Process",
      items: [
        "Concept of Learning",
        "Nature of Learning",
        "Types of Learning",
        ...
        "Theory of Conditioning (Classical and Operant)",
        "Montessori's Theory of Learning",
      ],
    },
    {
      title: "Phase 6 Child Psychiatry",
      items: [
        "Externalized disorders",
        "Internalized disorders",
        "Learning disorders",
        "Habitual disorders and TICS",
    ...
    {
      title: "Phase 7 Child's Health",
      items: [
        "Mother and Child Health",
        "Malnutrition",
        "Infection",
        "Unregulated fertility",
        "Interventions for improving the nutrition of mothers and children",
        "Health Check Point",
      ],
    },
    {
      title: "Phase 8 Mother and Child",
      items: ["Mother's Care and Habit formation", "Parental Control"],
    },
    {
      title: "Phase 9 Hygiene and individual Cleanliness",
      items: [
        "Meaning and Concept",
    ...
    {
      title: "Phase 10 Immunity measures and child safety",
      items: ["Concept", "Accidents", "Prevention", "First Aid", "Role of Mother and Teacher"],
    },
    {
      title: "Phase 11 Mastering AI and Digital Tools for Modern Education",
      items: [
  ...
  fee: "Diploma in Child Psychology is a unique course which helps gain insight into the thinking and behavioral patterns of children with which trainees can assist and nurture them for their full development. You need eligibility criteria of completion of grade 12 or graduation to apply for this Online/ Distance course to learn the early childhood teaching methodologies. You may pursue this course by spending a reasonable fee of 15000 INR + GST or 240 USD along with tutor guidance and course material support .",
  shared: {
    accreditation: [
