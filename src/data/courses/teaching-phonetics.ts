...
export const teachingPhoneticsCourse = {
  title: "Teaching Phonetics",
  image: "/images/courses/teaching-phonetics-detail.jpg",
  pageIntro: [
    'Phonetics is the study of speech. It is the study of how the sounds of a speech are produced and how they are used while speaking. Phonetics is the science of sounds, their production by means of lips, tongue, palate, and vocal chords, their acoustic qualities, their combination into syllables and other sound groups, stress and intonation. Phonetics will help you, how to pronounce a particular word correctly. It gives the correct pronunciation of a word both in British and American English. In order to help people with their speech and hearing, we need to know how speech sounds are produced (articulatory Phonetics) and how they are perceived (auditory Phonetics).In order to excel in the career of English language teaching, knowledge of phonetics will play a vital role. Global Teacher Training Academy (GTT Academy) offers a 4 month course on Teaching Phonetics that includes detailed methodology about how to teach phonetics and other valuable aspects. For "English" language teachers use of phonetics in the teaching of a foreign language, allows them to explain the differences between the sounds, improve the pronunciation and develop a better intonation, and helps to demonstrate the difference to the students. This Phonetic course helps you to consolidate your knowledge and uplift your career graph as it equips you with the necessary skills to enhance your teaching.',
  ],
  focus: [
    "Teaching Phonetics trains the teachers, interested learners on the art of pronunciation and the technicalities behind it.",
    "This course will help both experienced and aspiring teachers, to teach students how to pronounce correctly, but will also help to brush up on their own pronunciation and enunciation skills.",
    "The course includes detailed methodology about how to effectively teach phonetics to students.",
  ],
  eligibility: "You may apply for the course on successful completion of Grade 12 (10+2) or graduation.",
  whoCanJoin: [
    "Aspiring teachers: Who want to begin their careers as an ESL teacher.",
    "Practicing Teachers: Who are looking for an up-gradation as well as renew their skill set on Phonetics.",
    "Young mothers: Who want to be an effective educator at home for their children.",
    "Career changers: Who want a shift and embark on a career as an ESL teacher.",
  ],
  phases: [
    {
      title: "Phase 1",
      items: ["What is Phonology and Phonetics?", "Segmental and Supra Segmental Phonology"],
    },
    {
      title: "Phase 2",
      items: ["Organs of Speech", "Consonants", "Vowels"],
    },
    {
      title: "Phase 3",
      items: ["Phonetic Transcription", "Stress and Intonation"],
    },
    {
      title: "Phase 4",
      items: ["Weak and Strong Forms", "Why teach pronunciation"],
    },
  ...
  fee: "Teaching Phonetics is a specialized course which encompasses certain specific teaching techniques that help teaching phonetics in a remarkable manner to the trainees and is important for anyone who teaches foreign language. You need eligibility criteria of completion of grade 12 or graduation to apply for this Online/ Distance course to learn the early childhood teaching methodologies. You may pursue this course by spending a reasonable fee of 10000 INR + GST or 160 USD along with tutor guidance and course material support .",
  shared: {
    accreditation: [
