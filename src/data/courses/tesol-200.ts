...
export const tesol200Course = {
  ...
  badge: "PG DIPLOMA With Dual Specialisation/200-HOUR/8 Months",
  pageIntro: [
    ...
    "GTT Academy offers PG Diploma with Dual Specialisation/200 hour TESOL course dedicated towards the teaching aspirants looking for a successful teaching career across the globe. We offer two specialization papers. TEFL for Young Learners – Teachers willing to teach children across the world. TEFL for Business – For corporate trainers or teachers in language institutes who teaches adults Teaching Young Learners and Teaching Business English. On successful completion of the course, the candidate will be awarded a certificate which will be recognized globally and play a handful role to get job overseas. The PG Diploma with Dual Specialisation/200 hour TESOL course can be pursued at a very reasonable fee of Rs22000.",
  ],
  focus: [
    "The course is designed to train the aspiring teachers with teaching methods and techniques that can produce effective result. The course also serves the purpose of installing confidence among candidates to stand and deliver from any global classroom.",
  ],
  ...
  units: [
    ...
    },
    {
      ...
      modules: [
        {
          title: "Module 1 — TEACH ENGLISH GRAMMAR",
          items: [
            "Grammar and language learning",
            "Overview of grammar concepts",
            "Syntax",
            ...
            "Grammar activities",
            "Selecting suitable materials for teaching grammar",
            "Vocabulary building using grammatical structures",
          ],
        },
        {
          title: "Module 2 — Teach Spelling and Pronunciation",
          items: [
            "Teach Pronunciation",
      ...
      modules: [
        {
          ...
          items: [
            ...
            "Understanding Student-Teacher Power Dynamics",
            "Strategies for Balancing Power",
            "ESOL case studies",
          ],
        },
        {
          title: "Module 2.1: Receptive Skills: Teach Listening",
          items: [
            "The listening skill",
            "Listening strategies",
            "Listening texts based on real life listening texts and situation",
            "Techniques for practising a variety of listening skills",
            "Overcoming listening challenges",
            "Principles for teaching listening comprehension",
            "Listening without written activities",
            "Example listening lesson plan",
            "Monitoring ESL learners' listening",
          ],
        },
        {
          title: "Module 2.2: Receptive Skills: Teach Reading",
          items: [
            "Foundational reading skills and conventions",
            "Authentic or adapted real-life texts",
            "Evaluating Published materials",
            "Reading for social purposes: tasks, texts and strategies",
            "Learning activities to develop reading strategies and skills",
            "Writing comprehension exercises",
            "Critical literacy",
            "Reading activities",
            "Example reading lesson plan",
            "Giving feedback and correction",
          ],
        },
        {
          title: "Module 3.1: Productive Skills: Teach Speaking",
          items: [
            "Spoken genres",
            "Text analysis",
            "Lesson planning",
        ...
        {
          title: "Module 3.2: Productive Skills: Teach Writing",
          items: [
            "Teaching foundational writing skills and conventions",
            "Needs analysis",
            "Analysing written texts",
            "Planning a unit of work",
            "Feedback and error correction",
            "Selecting materials suitable for a range of levels",
            "Example writing lesson plan and activities",
          ],
        },
        {
          title: "Module 4: Visual & Instructional Aids",
          items: [
            "The Importance of Teaching Aids and Different Mediums",
            "VAK/VARK Model; Gardner's Theory",
            "Traditional Instructional Tools and Their Continued Relevance",
            "Visual Aids and Contextualized Meaning",
            "Designing Effective Classroom Materials",
            "Adaptation to Diverse Learning Contexts",
            "Integrating Tools for Holistic Learning",
            "Digital and Audio-Visual Aids: Maximizing Engagement and Recall",
            "Benefits of Using Technology in the Classroom",
            "Pointers for planning English language learning activities using technology",
            "Suggested search categories",
            "Use music, art and drama to teach English",
            "Strategically combining teaching mediums",
    ...
    {
      title: "UNIT 5: ESOL Life Competencies",
      modules: [
        {
          title: "Module 1 ESOL Skills and Programmes",
          items: [
            "Introduction to ESOL Programmes and Contexts",
            "Needs Analysis and Course Design",
            "The Process of Needs Analysis for ESOL Learners",
            "Identifying Specific Language Learning Needs",
            "ESOL Programme Types and Distinctions",
            "Differentiating ESOL Life Skills from General English (GE)",
            "English for Specific Purposes (ESP) and its Relevance to Life Skills",
            "Embedded Language Provision and CLIL (Content and Language Integrated Learning)",
            "Critical Evaluation of ESOL Programmes and Materials",
            "Principles of Programme Evaluation",
            "Criteria for Evaluating ESOL Published Materials and Resources",
            "Assessment of Learner Proficiency",
            "Overview of International Second Language Proficiency Ratings (ISLPR) and other Frameworks",
          ],
        },
        {
          ...
          items: [
            ...
            "Learner levels and macro-skills",
            "Implications",
            "Special needs",
            "The Seven Key Types of Learning Difficulties (SpLDs)",
            "Specific Focus: Identifying Dyslexia in ESOL Learners",
            "Impact on Language Outcomes",
            "Universal Design for Learning (UDL) in ESOL",
            "Strategy Application: Adapting Materials and Tasks",
            "Strategy Application: Supporting the Specific SpLDs",
            "Learning example to illustrate the principles of Universal Design for Learning (UDL) and adaptation for SpLDs",
          ],
        },
      ],
    },
    {
      title: "Unit 6-English for Specific Purpose (ESP)-Business English",
      items: [
        "The purpose of ESP Programs",
        "ESP programs breakdown",
        ...
        "Developing a learning program in ESP",
    ...
    {
      title: "Unit 7 Teach English to early childhood learners",
      items: [
        "Language use in the early childhood years",
        "Planning a learning program",
        "Monitoring and evaluating ESL learning",
      ],
    },
    {
      title: "Unit 8 Mastering AI and Digital Tools for Modern Education",
      items: [
  ...
  fee: "The PG Diploma with Dual Specialisation/180 hour TESOL course can be pursued at a very reasonable fee of Rs22000.",
