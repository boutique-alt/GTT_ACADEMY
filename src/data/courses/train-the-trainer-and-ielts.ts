...
export const trainTheTrainerCourse = {
  ...
  phases: [
    {
      title: "Phase 1 — Training and learning",
      items: [
...
export const ieltsForTeachersCourse = {
  ...
  pageIntro: [
    ...
    "In today’s globalized world, demand for qualified EFL teachers is soaring. IELTS assesses your English skills, and our 6-month online training course prepares you for a successful career in English teaching. To enroll, you must have graduation in any discipline. The course is flexible, allowing you to learn at your own pace.",
  ...
  focus: [
    "Strengthen your Listening, Reading, Speaking and Writing abilities through structured lessons.",
  ...
  whoCanJoin: [
    "Teachers who wish to expand their expertise by adding IELTS-focused teaching to their existing English-language teaching skills.",
    "Graduates and English-language professionals who wish to develop the knowledge and practical skills required to train learners in the IELTS framework and four language skills.",
    "Educators, trainers and language professionals seeking to strengthen their understanding of IELTS methodology, assessment and learner evaluation.",
    "Individuals interested in developing their knowledge of IELTS assessment practices, performance criteria and effective feedback techniques.",
  ],
  phases: [
    {
      title: "Unit 1: General Information",
      items: [
    ...
    {
      title: "Unit 6: Structuring Your IELTS Course",
      items: [
        "Two objectives",
        "Teaching one to one",
        "Teaching a group",
  ...
  fee: "IELTS for Teachers is a 6-month online training course that prepares graduates for IELTS excellence and English teaching careers. You must have graduation in any discipline to enroll. You may pursue this course by spending a reasonable fee of 15000 INR + GST or 220 USD along with tutor guidance and course material support.",
