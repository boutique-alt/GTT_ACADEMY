...
export const counselingCourse = {
  title: "Diploma in Child and Adolescent Counseling",
  image: "/images/courses/counseling-detail.jpg",
  pageIntro: [
    "Child and Adolescent counseling is a process to assess children through their school environment, their temperament, habits, parents, likes-dislikes and psychometric tests. The subject identifies the problems and thus providing the best possible solution.",
    "Diploma in Child and Adolescent counseling from Global Teacher Training Academy (GTT Academy) is a unique course that helps to equip learners with a unified approach to foster the development of young children and improve their physical, emotional, social and spiritual wellbeing.",
    "The course is also ideal for those wishing to set up early childhood care and education centres or managing such centres; parents and others interested in knowing about the development of young children. The Diploma Course on Child and Adolescent counseling from GTT Academy is an 8 months course, which can be completed with ease through flexible learning methods of Online Learning. The advantages of taking this course are that you can study it from anywhere and from any device. Upon completion of the course, GTT Academy will award a globally accepted certificate which can be effective to add optimum value to the credibility of a child counsellor.",
  ],
  courseInformation: [
  ...
  phases: [
    {
      title: "Phase 1",
      items: [
        "1.1 What is Child and Adolescent Counseling?",
        "1.2 The Child's natural surroundings",
        "1.3 How Do I Become a Children's and Adolescents' Counselor?",
        "1.4 What Does a Child and an Adolescent Counselor do?",
        "1.5 Where Do Child and Adolescent Counselors Work?",
        "1.6 Counselling Relationship with children and adolescents",
      ],
    },
    {
      title: "Phase 2",
      items: [
        "2. Growth and Development of Child",
        "2.1 Concept of growth and development",
        "2.2 Stages of development",
        "2.3 Determinants of development: heredity and environment",
        "2.4 Psychological development in children",
      ],
    },
    {
      title: "Phase 3",
      items: [
        "3.1 Conflict and Stress in Children and Adolescents",
        "3.2 Behavioral Therapy",
        "3.3 Working with Children and Adolescents",
        "3.4 Respect for client",
      ],
    },
    {
      title: "Phase4",
      items: [
        "4.1 Grief and Bereavement in Children and Adolescents",
        "4.2 Extending assistance and support to grieving children and adolescents",
        "4.3 Dysfunctional families",
        "4.4 Dysfunctional parenting style",
        "4.5 Co-Dependency",
      ],
    },
    {
      title: "Phase 5",
      items: [
        "5.1 The psychology of learning",
        "5.2 What Is Behaviorism?",
        "5.3 Three Types of Learning in Psychology",
        "5.4 History of the Psychology of Learning",
        "5.5 Transformation and change in counselling",
      ],
    },
    {
      title: "Phase 6",
      items: [
        "6.1 Prerequisites for starting your private practice",
        "6.2 Considering the challenges in running your own practice",
        "6.3 Create Business Plan",
        "6.4 Choice of establishment (Decisions about office space and Logistics)",
        "6.5 Considering legal requirements and Insurance",
        "6.6 Networking with other therapist",
    ...
    {
      title: "Phase 7 Mastering AI and Digital Tools for Modern Education",
      items: [
