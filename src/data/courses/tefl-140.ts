...
export const tefl140Course = {
  ...
  pageIntro: [
    ...
    "GTT Academy offers an intense Diploma/140-hour online TEFL Course aiming towards the aspiring teachers looking for a successful career in the field of Teaching English as a Foreign Language. EFL teaching can be an exciting opportunity for who has a special heart for teaching and traveling. Regular development in the field of TEFL has increased an insatiable demand for qualified EFL teachers. Teaching English to young learners is an inseparable part of EFL teaching. The Diploma/140-hour online TEFL Course can be pursued at a very reasonable fee of Rs14000.",
  ],
  focus: [
    "The TEFL course includes module on teaching young learners in order to equip the aspiring teachers with skills required for global teaching career.",
    "You will learn methods for engaging students and imparting knowledge among them in the most effective ways.",
  ],
  eligibility: "10+2 or Graduate in Any Discipline",
  whoCanJoin: [
  ...
  units: [
    {
      ...
      subtitle: "Preparation and Orientation Module",
      items: [
        "Motivation in Learning",
        "Planning & Organising Study",
        "Effective Study Skills",
        "Register in English",
        "Genre Approach to Learning",
      ...
      modules: [
        {
          ...
          items: [
            "Introduction",
            "Why Grammar Matters for an ESL Teacher",
            "Key Grammatical Terminology",
            "The Inductive and Deductive Approach to Grammar",
            "The nine Parts of Speech",
            "Verbs: The Action Words",
            "Sentence Structure",
            "Tenses: Describing Time in English",
            "Gerunds",
            "Articles",
            "Using a Grammar Reference",
        ...
        },
        {
          ...
          items: [
            ...
            "The Speech Organs",
            "Classroom Strategies on Pronunciation",
            "Intonation",
    ...
    },
    {
      ...
      modules: [
        {
          title: "Module 1: Contexts & Core Approaches in TEFL",
          items: [
            "The ESOL Landscape-Challenges Learners Face",
            ...
            "Motivation",
            "Managing Teacher Talk Time",
            "Maintaining Engagement in Class",
            "Correction Strategies",
            "Classroom Dynamics",
            "Exam preparation",
            "The Role of Grammar in Communicative Contexts",
            "Approaches to One-on-One Instruction",
          ],
        },
        {
          ...
          items: [
            ...
            "Understanding Listening and Reading Types",
            "Matching Materials to Learner Levels (Basic)",
            "Listening activities at different levels",
            "Overcoming listening challenges",
            "The Three-Phase Lesson Model (P-W-P)",
            "Crafting Core Comprehension Questions",
            "Sequencing Tasks: From Pre- to Post-Phase",
        ...
        },
        {
          ...
          items: [
            "Introduction",
            "Text Analysis",
            "Role of Vocabulary in Speaking Lessons",
            "Lesson Planning (Outline of Steps)",
            "Practice Activities for Speaking",
            "Writing",
            "The Process Approach to Writing",
            "Focus on Cohesion and Feedback",
          ],
        },
        {
          title: "Module 4: Visual & Instructional Aids",
          items: [
            "The Indispensable Role of Visual and Interactive Aids in TEFL/TESOL",
            "The Role of Audio-Visual Technologies in Teaching",
            "Traditional Instructional Tools and Their Continued Relevance",
            "Digital and Audio-Visual Aids: Maximizing Engagement and Recall",
            "Use music, art and drama to teach English",
            "Integrating Aids into Lesson Planning",
          ],
        },
        {
          title: "Module 5 Assessment of English Language skills",
          items: [
            "Assessment in ESL Contexts",
            "Forms of assessment and types of evidence",
      ...
      modules: [
        {
          ...
          items: [
            ...
            "Practical tips for classroom teaching (Code of Conduct)",
          ],
        },
        {
          ...
          items: [
            "Introduction",
            "Need Analysis",
            'Why "Meaningful, Relevant, Useful, and Interesting" Matters',
            "Identifying language learning needs",
            "Performance criteria and learning objectives",
            "Planning lessons based on communicative language learning methodology",
            "Sample of a lesson plan fulling the 3 criteria mentioned above.",
            "The Presentation, Practice, and Production (PPP) Model",
            "Lesson Plan: Buying a Second-Hand Car",
            "Teaching Aids",
            "Assessment in ESL Contexts: Formal vs. Non-Formal Settings",
            "Formal and informal methods of assessment",
            "Key Purposes of ESL Assessment",
            "Types of Assessment in ESL",
            "The Integrated Cycle of ESL Teaching",
          ],
        },
      ],
    },
    {
      title: "UNIT 5: Pedagogy for young learners",
      items: [
        "Contexts for TESOL with Very Young Learners",
        "Language use in the early childhood years",
        "First language development",
        "Functions and social purposes of communication by very young children",
        "Categories and examples of concepts",
        "Planning a learning program",
        "Activities",
      ],
    },
    {
      title: "Unit 6: Mastering AI and Digital Tools for Modern Education",
      items: [
  ...
  fee: "120 Hour Diploma in TEFL course can be pursued at a very reasonable fee of Rs14000.",
  ...
  assessment: [
    ...
    "At GTT Academy we have experienced tutors that help shape the learning curve of the learners.",
