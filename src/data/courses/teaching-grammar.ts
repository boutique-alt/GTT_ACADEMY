...
export const teachingGrammarCourse = {
  title: "Teaching Grammar",
  image: "/images/courses/teaching-grammar-detail.jpg",
  pageIntro: [
    'Grammar forms the basis of English language. English as a second or a foreign language is not acquired naturally, instruction and structured learning are important. ESL teachers and learners learn how to construct correct sentences and study the governance of the syntax or word orders that are crucial for learning the language. Communicative proficiency involves knowledge and application of grammar and use of appropriate vocabulary of the language to convey meanings in a socially acceptable way. Grammar improves your Listening and Speaking skills. The specialized course for "Teaching Grammar" in Global Teacher Training (GTT Academy) helps one to achieve proficiency in English Grammar with the ability to use it with confidence through clear explanations that include verbs, direct and indirect speech, word classes, sentence constructions and lexis. GTT academy offers 4 months of intensive course on teaching English grammar which could be completed with ease through flexible learning methods of Online learning. The certificate which is globally accepted, awarded on completion of the course can be effective to add optimum value to the credibility of a teacher.',
  ],
  focus: [
    "Enable students to communicate effectively.",
    "Connects grammar points with larger communication contexts.",
    "To develop and integrate the use of the four language skills i.e. Listening, Speaking, Reading and Writing.",
    "Teaching effective grammar methodologies and techniques in the classroom",
  ],
  ...
  online: {
    ...
    items: [
      ...
      "Full Tutor Support",
      "Online MCQ and Teaching assignment",
    ],
  },
  fee: "Teaching Grammar is a specialized course which encompasses certain specific teaching techniques that help teach Grammar methodologies in a to facilitate effective communication skills and is important for anyone who teaches foreign language. You need eligibility criteria of completion of grade 12 or graduation to apply for this Online/ Distance course to learn the early childhood teaching methodologies. You may pursue this course by spending a reasonable fee of 10000 INR + GST or 160 USD along with tutor guidance and course material support .",
  shared: {
    accreditation: [
