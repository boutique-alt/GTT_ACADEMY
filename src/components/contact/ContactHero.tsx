  ...
  return (
    <>
      <section className="relative isolate aspect-video w-full overflow-hidden bg-[#05245b]">
        <CoverImage src="/images/contact-hero.jpg" alt="Contact GTT Academy" priority />
        <div
        ...
        <div className="relative z-10 flex h-full w-full">
          <div className="flex h-full w-[min(48%,26rem)] items-center px-4 py-5 sm:w-[min(44%,30rem)] sm:px-8 sm:py-8 lg:w-[min(58%,52rem)] lg:items-start lg:px-12 lg:pt-16 lg:pb-10 xl:w-[min(60%,56rem)] xl:px-16 xl:pt-20 xl:pb-12">
            <p className="border-l-[3px] border-[#ffbc09] pl-3 font-serif text-[clamp(0.95rem,2.6vw,2rem)] font-semibold uppercase leading-[1.45] tracking-[0.04em] drop-shadow-[0_2px_10px_rgba(3,27,70,0.45)] sm:pl-5 sm:leading-[1.5] lg:border-l-4 lg:pl-6 lg:text-5xl lg:leading-[1.1] lg:tracking-[-0.01em] xl:text-[4.5rem] xl:leading-[1.05]">
