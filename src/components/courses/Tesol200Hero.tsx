...
export default function Tesol200Hero() {
  return (
    <>
      <section className="relative isolate w-full overflow-hidden bg-[#05245b]">
        <div className="relative aspect-[4/3] w-full sm:aspect-video">
          <div
            ...
            style={{ backgroundImage: "url(/images/tesol-200-hero.jpg)" }}
            role="img"
            aria-label="200 Hour TESOL Course PG Diploma at GTT Academy"
          />
          <div
      ...
      <div className="bg-brand-gradient py-4 sm:py-5 lg:py-7">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-center font-display text-2xl font-semibold tracking-[-0.02em] text-white sm:text-3xl lg:text-[2.75rem] lg:leading-[1.15] xl:text-[3.5rem]">
