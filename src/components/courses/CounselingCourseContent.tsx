...
export default function CounselingCourseContent() {
  const course = counselingCourse;

  const accordionItems = [
    {
      title: "Course Information",
      content: <CourseBulletList items={course.courseInformation} />,
    },
    {
      title: "Eligibility",
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <h4 className="font-serif text-lg font-bold text-[#05245b]">{course.distance.title}</h4>
          <p>{course.distance.text}</p>
          <CourseBulletList items={course.distance.items} />
        </div>
      ),
    },
    {
