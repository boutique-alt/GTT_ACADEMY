...
export default function FinalCta() {
  return (
    <section className="relative overflow-hidden bg-brand-gradient px-4 py-16 text-white">
      <div className="absolute -left-24 top-0 size-64 rounded-full border-[40px] border-white/10" />
      <div className="absolute -right-16 bottom-0 size-48 rounded-full bg-[#ffbc09]/20 blur-2xl" />
